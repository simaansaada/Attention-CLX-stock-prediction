...
############################### read the ARIMA pre-processing file. that generated by executing the ARIMA.py code.  #######################
############################### make sure to execute the ARIMA.py file befiore running this file. #########################################
...
config = Config()
name = config.dimname
############################################################### fine tuning (xgboost) and then predict data. ##########################
